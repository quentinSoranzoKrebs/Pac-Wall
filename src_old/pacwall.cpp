...
int main(void) {
  ...
  //Monster
	...
	while (!WindowShouldClose()) {
        ...
        player.Update(envItems, envItemsLength, deltaTime, direction, JumpButton.ispressed());
        mstr.Update(envItems, envItemsLength, deltaTime, player.position);
        ...
        BeginDrawing();
            ...
            BeginMode2D(camera);
                ...
                for (int i = 0; i < envItemsLength; i++) {
                  ...
                  DrawRectangleRoundedLines(envItems[i].rect, 1, 60, -7, envItems[i].color);
                };
